//
//  ZHProgressView.m
//  ZHProgressView-Example
//
//  Created by W.zh Coneybeare on 5/25/14.
//

#import "ZHProgressView.h"

NSString * const ZHProgressViewProgressAnimationKey = @"ZHProgressViewProgressAnimationKey";

@interface ZHCircularProgressView : UIView
...
@interface ZHProgressView () <UIGestureRecognizerDelegate>

@property (nonatomic, strong) ZHCircularProgressView *progressView;
...
- (void)sharedSetup {
	self.progressView = [[ZHCircularProgressView alloc] initWithFrame:self.bounds];
...
- (void)animateToProgress:(CGFloat)progress {
    ...
    [self.progressView.layer addAnimation:animation forKey:ZHProgressViewProgressAnimationKey];
...
- (void)stopAnimation {
    ...
    [self.progressView.layer removeAnimationForKey:ZHProgressViewProgressAnimationKey];
...
#pragma mark - ZHCircularProgressView

@implementation ZHCircularProgressView
