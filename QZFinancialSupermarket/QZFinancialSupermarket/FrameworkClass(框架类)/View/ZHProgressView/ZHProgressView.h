...
@interface ZHProgressView : UIView <CAAnimationDelegate>
 ...
 */
@property (nonatomic, copy) void (^fillChangedBlock)(ZHProgressView *progressView, BOOL filled, BOOL animated);
 ...
 *  Example usage would be to invert the colors on your centralView
 */
@property (nonatomic, copy) void (^didSelectBlock)(ZHProgressView *progressView);
 ...
 */
@property (nonatomic, copy) void (^progressChangedBlock)(ZHProgressView *progressView, CGFloat progress);
